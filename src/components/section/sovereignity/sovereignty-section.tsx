    ...
    <div className="max-w-7xl mx-auto bg-[#141414] rounded-3xl p-8 sm:p-12 lg:p-16">
      ...
      <div className="text-center mb-12 sm:mb-16">
        <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold mb-4 sm:mb-6 leading-tight text-white tracking-tight">
          {t("sovereignty.titlePrefix")}
          <span className="text-orange-500"> {t("sovereignty.titleHighlight")} </span>  <br /> {t("sovereignty.titleSuffix")}
        </h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-4 w-full cursor-pointer">
        ...
        <WobbleCard containerClassName="col-span-1 sm:col-span-2 lg:col-span-3 min-h-[240px] sm:min-h-[280px] bg-[#1c1c1c] border border-white/5 group relative overflow-hidden">
          <div className="p-4 sm:p-6">
            <div className="flex flex-col sm:flex-row sm:items-center gap-3 mb-4">
              <div className="w-10 h-10 bg-orange-500/10 rounded-lg flex items-center justify-center flex-shrink-0">
                <Shield className="text-orange-500" size={20} />
              </div>
              <h3 className="text-left text-balance text-lg sm:text-xl font-semibold tracking-[-0.015em] text-white">
                {t("sovereignty.mainCard.titleLine1")}
                <br /> {t("sovereignty.mainCard.titleLine2")}
              </h3>
            </div>
            <p className="text-left text-base sm:text-base text-gray-400 leading-relaxed">
              {t("sovereignty.mainCard.description")}
            </p>
          </div>
          <div className="absolute inset-x-0 bottom-0 bg-[#1c1c1c] border-t border-white/5 p-3 sm:p-4 transition-colors duration-300 ease-out w-full">
            <div className="flex flex-wrap gap-1.5 sm:gap-2">
              {t("sovereignty.mainCard.chips.0") && (
                <span className="px-2 py-1 sm:px-3 sm:py-1 bg-transparent border border-orange-500/50 rounded-full text-orange-500 text-xs sm:text-sm font-medium transition-colors duration-300 group-hover:bg-orange-500 group-hover:text-white">
                  {t("sovereignty.mainCard.chips.0")}
                </span>
              )}
        ...
        <WobbleCard containerClassName="col-span-1 sm:col-span-2 lg:col-span-3 min-h-[240px] sm:min-h-[280px] bg-[#1c1c1c] border border-white/5 group relative overflow-hidden">
          ...
          <div className="absolute inset-x-0 bottom-0 bg-[#1c1c1c] border-t border-white/5 p-3 sm:p-4 transition-colors duration-300 ease-out">
            <div className="flex flex-wrap gap-1.5 sm:gap-2">
        ...
        {/* Chiffrement card */}
        <WobbleCard containerClassName="col-span-1 sm:col-span-1 lg:col-span-2 min-h-[220px] sm:min-h-[250px] bg-[#1c1c1c] border border-white/5 group relative overflow-hidden">
          <div className="p-4 sm:p-6">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 bg-orange-500/20 rounded-lg flex items-center justify-center">
                <Lock className="text-orange-500" size={20} />
              </div>
              <h3 className="text-left text-balance text-base sm:text-lg font-semibold tracking-[-0.015em] text-white">
                {t("sovereignty.encryption.title")}
              </h3>
            </div>
            <p className="text-left text-base text-gray-400 leading-relaxed">
        ...
        <WobbleCard containerClassName="col-span-1 sm:col-span-2 lg:col-span-6 bg-[#1c1c1c] border border-white/5 min-h-[180px] sm:min-h-[200px] group relative overflow-hidden">
          <div className="p-4 sm:p-6">
            <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4 lg:gap-6">
              <div className="w-full lg:max-w-md">
                <div className="flex flex-col sm:flex-row sm:items-center gap-3 mb-4">
                  ...
                  <h3 className="text-left text-balance text-lg sm:text-xl md:text-2xl font-semibold tracking-[-0.015em] text-white">
              ...
              <div className="flex flex-wrap sm:flex-nowrap items-center gap-3 sm:gap-4 w-full lg:w-auto">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-gray-400 text-xs sm:text-sm font-medium">{t("sovereignty.supervision.badges.0")}</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle className="text-green-500 sm:w-5 sm:h-5 w-4 h-4" />
                  <span className="text-gray-400 text-xs sm:text-sm font-medium">{t("sovereignty.supervision.badges.1")}</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle className="text-green-500 sm:w-5 sm:h-5 w-4 h-4" />
                  <span className="text-gray-400 text-xs sm:text-sm font-medium">{t("sovereignty.supervision.badges.2")}</span>
                </div>
              </div>
            </div>
          </div>
